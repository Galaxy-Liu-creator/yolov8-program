 # D15_20260119203927 人工复核记录（5.7 阶段）

 ## 1. 本文件作用

 这个文件用于记录 `D15_20260119203927` 这条序列在 5.7 阶段的人工语义复核结论。
 ...
 | --- | --- | --- | --- | --- | --- |
 | D15_20260119203927_frame_0142 | crowded_or_localization / medium_large_pose_or_appearance | occluded |  | false | 第二人几乎无响应，overlay 中未见有效候选框 |
 | D15_20260119203927_frame_0143 | medium_large_pose_or_appearance / small_interior_person | crowded_or_overlap |  | false | 第二人几乎无响应，overlay 中未见有效候选框 |
 | D15_20260119203927_frame_0180 | medium_large_pose_or_appearance / small_interior_person | crowded_or_overlap |  | false | 两人重叠 |

 ## 5. 当前待回答的问题

 1. 这条序列的主问题是否与 `D15_20260119061405` 同质？否
 2. 是否更偏姿态异常、人体外观不完整或对比度不足？否
 3. 是否存在少量边界小人，但并不是主问题？否
