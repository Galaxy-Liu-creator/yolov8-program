...
- 更推荐使用符合地面业务语义的 **框底边中心点规则（可近似脚点语义）**；
...
- 对刚进入 ROI 或半身进入 ROI 的人，中心点可能仍在 ROI 外，但框底边中心点更可能已经进入 ROI，更接近脚点落地区域。
...
- 如果框底边中心点在 ROI 内，直接保留；
- 如果框底边中心点不在 ROI 内，但 person 框至少有 `25%` 面积在 ROI 内，也保留；
- 否则丢弃。
...
- `bottom_center_inside=true`：优先使用“框底边中心点在 ROI 内”的判定，近似脚点语义；
...
**看人的框底边中心点是否进入业务地面区域，或者至少有足够比例的人框已经进入 ROI。**
